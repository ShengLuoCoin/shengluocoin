...
// Copyright (c) 2013 The ShengLuoCoin developers
...
uint256 hashGenesisBlock("0x00000e2a8000f09743839ad0374fcb18fcf22ca03d333019c373260c5f581a23");
static const unsigned int timeGenesisBlock = 1471856469;
...
const string strMessageMagic = "ShengLuoCoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "ShengLuoCoin create";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xe95b3438e6a91a85173e9978482943b31b767c23424fb62af338c54310bfefec"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ShengLuoCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ShengLuoCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("ShengLuoCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("ShengLuoCoin-miner");
    ...
    try { loop {
        ...
        printf("Running ShengLuoCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("ShengLuoCoinMiner terminated\n");
        throw;
    }
}
