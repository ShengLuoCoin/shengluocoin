...
const QString BITCOIN_IPC_PREFIX("ShengLuoCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click ShengLuoCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start ShengLuoCoin: click-to-pay handler");
    else
...
{
    // clicking on ShengLuoCoin: URLs creates FileOpen events on the Mac:
